...
const V12_CONFIG = {
   ...
   * (без лока и без тяжёлой работы), а минутный триггер v12ScheduledQueueDrain
   * применяет всё пакетно, одним пересчётом проекций. Очередь — первичный
   * источник истины: значение не теряется, даже если колонку/ячейку перезапишет
   * пересборка проекции.
   *
