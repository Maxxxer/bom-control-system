...
const V12_CONFIG = {
   ...
   * «<дефицит> - <номер проекта> - <крайняя дата поставки>», по строке на
   * проект, отсортированный по дате поставки по возрастанию (самый ранний
   * сверху). Пример: «4 - 1234.АБВ - 05.09.2026».
   */
  SUPPLY_COLUMNS: {
    MATERIAL_KEY: 1,
    MATERIAL_CODE: 2,
