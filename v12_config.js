...
const V12_CONFIG = {
  ...
  /**
   * СНАБЖЕНИЕ (SUPPLY) (12) — агрегация по materialKey.
   * Колонка PROJECTS — перечень проектов, использующих материал, в формате
   * «<дефицит> - <номер проекта> - <крайний срок>», по строке на проект,
   * отсортированный по крайнему сроку по возрастанию (самый ранний сверху).
   * Для проекта берётся САМЫЙ РАННИЙ крайний срок его позиций (самое жёсткое
   * ограничение). Пример: «4 - 1234.АБВ - 20.09.2026».
   */
  SUPPLY_COLUMNS: {
    MATERIAL_KEY: 1,
    MATERIAL_CODE: 2,
