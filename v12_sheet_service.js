 ...
 * «BOM (кол-во)» и «Обновлено» добавлены в список устаревших — из канона
 * листа колонки убраны.
 */
const V12_SUPPLY_LEGACY_HEADERS = ["Всего требуется", "Всего зарезервировано", "BOM (кол-во)", "Обновлено"];

/**
 * Миграция листа СНАБЖЕНИЕ под новую схему.
 *
 * В прежних схемах СНАБЖЕНИЕ содержало колонки «Всего требуется», «Всего
 * зарезервировано», «BOM (кол-во)» и «Обновлено». Из канона (10 колонок) они
 * убраны. Миграция удаляет любые устаревшие колонки из заголовка и приводит
 * строку заголовков к канону. Тело листа не трогаем — оно пересобирается
 * v12RefreshSupply.
 */
